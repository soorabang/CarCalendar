    ...
    static class EventViewHolder extends RecyclerView.ViewHolder {
        ...
        EventViewHolder(ViewGroup parent) {
            ...
            mCalendarIndicatorPadding =
                    (int) parent.getResources().getDimension(com.android.car.ui.R.dimen.car_ui_padding_1);
            mTimeTextColor =
                    ContextCompat.getColor(parent.getContext(), com.android.car.ui.R.color.car_ui_text_color_primary);
        }
